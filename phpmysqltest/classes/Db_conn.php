...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mdaida';//this will be your WCC username
      $dbUsr = 'mdaida';//this will be your WCC username
      $dbPass = 'HyDDXYzeY9kK';//this will be the password found in the video.
